    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button_myeong_eon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(myeong_eon_study.this, myeong_eon_categori.class);
        ...
        Button_sangsik2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(myeong_eon_study.this, sang_sik_categori.class);
                startActivity(intent);
            }
        });
        ...
        Button_quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(myeong_eon_study.this, quiz_categori.class);
                startActivity(intent);
            }
        });
