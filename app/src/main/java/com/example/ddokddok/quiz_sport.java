    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button_myeong_eon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(quiz_sport.this, myeong_eon_categori.class);
        ...
        Button_sangsik2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(quiz_sport.this, sang_sik_categori.class);
                startActivity(intent);
            }
        });
        ...
        Button_quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(quiz_sport.this, quiz_categori.class);
                startActivity(intent);
            }
        });
